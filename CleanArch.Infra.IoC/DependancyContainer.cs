...
namespace CleanArch.Infra.IoC
{
    public class DependancyContainer
    {
        public static void RegisterServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IRequestHandler<UpdateProductCommand, bool>, UpdateProductCommandHandeler>();
            //services.AddScoped<IRequestHandler<DeleteProductCommand, bool>, DeleteProductCommandHandeler>();
